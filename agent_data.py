...
AGENT_DESIGN = {
    ...
    "Neon": {
        ...
        "replaceability": 0.5, "role_niche": "speed_smoke_duelist",
...
AGENT_RELATIONS = {
    ...
    "Phoenix": {
        ...
        "suppressed_by": [
            {"agent":"Neon",    "type":"replaces", "reason":"네온이 더 강한 이동기+연막+CC → 피닉스의 화염 장판은 B급 유틸로 경쟁 불가"},
        ],
    },
    "Harbor": {
        "suppressed_by": [
    ...
    "Neon":   {"dominance_note": "S급 연막 + CC + 이동기 = 타격대 최고 킷 가치(3.25). 랭크/대회 모두 고픽 → 너프 압박."},
